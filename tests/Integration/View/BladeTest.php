...
<div>Slot: F, Color: yellow, Default: foo</div>', trim($view));
    ...
    public function testViewCacheCommandDoesNotCompileViewsInSubdirectoryOfBasePathTwice()
    {
        // Register a hinted namespace pointing to a subdirectory of the base view path.
        // Without path deduplication, views in components/ would be compiled twice.
